...
export function DataStatus(props) {
    ...
    fetch(process.env.NODE_ENV === 'development' ? 'http://localhost:18080/api/Sales/Daily?days=' + props.period : 'https://www.danspizza.dev/api/Sales/Daily?days=' + props.period, headers)
        .catch((error) => {
